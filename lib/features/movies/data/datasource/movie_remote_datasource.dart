...
abstract class MovieRemoteDatasource {
  Future<List<MovieSummaryModel>> fetchPopularMovies({int page = 1, List<int>? genreIds});
  Future<List<MovieSummaryModel>> fetchTopRatedMovies({int page = 1, List<int>? genreIds});
  Future<List<MovieSummaryModel>> fetchUpcomingMovies({int page = 1, List<int>? genreIds});
