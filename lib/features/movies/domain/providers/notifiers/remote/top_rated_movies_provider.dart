...
class TopRatedMoviesNotifier extends BasePaginatedMoviesNotifier {
  @override
  ...
  Future<List<MovieSummary>> fetchItems(int page) async {
    final genreIds = ref.read(selectedGenresProvider);
    return await ref
        .read(movieRepositoryProvider)
        .fetchTopRatedMovies(page: page, genreIds: genreIds);
  }
}
