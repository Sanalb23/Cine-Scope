...
abstract class MovieRepository {
  Future<List<MovieSummary>> fetchPopularMovies({int page = 1});
  Future<List<MovieSummary>> fetchTopRatedMovies({int page = 1});
  Future<List<MovieSummary>> fetchUpcomingMovies({int page = 1});
